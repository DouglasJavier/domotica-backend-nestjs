...
export class Init1706649953166 implements MigrationInterface {
    name = 'Init1706649953166'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "proyecto"."historialIncidentes" ("id" BIGSERIAL NOT NULL, "fecha" TIMESTAMP WITH TIME ZONE NOT NULL, "feacha_atencion" TIMESTAMP WITH TIME ZONE, "estado" character varying(20) NOT NULL, "usuario_auditoria" bigint, "idAlarma" bigint NOT NULL, "id_sensor" bigint NOT NULL, CONSTRAINT "PK_93b41a55cace0854c234a67e361" PRIMARY KEY ("id"))`);
