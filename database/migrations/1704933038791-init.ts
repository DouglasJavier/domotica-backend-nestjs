...
export class Init1704933038791 implements MigrationInterface {
    name = 'Init1704933038791'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "proyecto"."dispositivos" ("id" BIGSERIAL NOT NULL, "nombre" character varying(50) NOT NULL, "tipo" character varying(50) NOT NULL, "direccionLan" character varying(200) NOT NULL, "direccionWan" character varying(200), "estado" character varying(20) NOT NULL, "idUbicacion" bigint NOT NULL, CONSTRAINT "PK_e9595bb1be0bf2b2e376b904434" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "proyecto"."historialIncidentes" ("id" BIGSERIAL NOT NULL, "fecha" TIMESTAMP WITH TIME ZONE NOT NULL, "estado" character varying(20) NOT NULL, "idAlarma" bigint NOT NULL, "id_sensor" bigint NOT NULL, CONSTRAINT "PK_93b41a55cace0854c234a67e361" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "proyecto"."sensores_actuadores" ("id" BIGSERIAL NOT NULL, "pin" character varying(5) NOT NULL, "tipo" character varying(25) NOT NULL, "descripcion" character varying NOT NULL, "id_ubicacion" bigint NOT NULL, "estado" character varying(20) NOT NULL, "id_dispositivo" bigint NOT NULL, CONSTRAINT "PK_c62ec2b169b1473df74917703a5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "usuarios"."usuario" ("id" BIGSERIAL NOT NULL, "nombres" character varying(60) NOT NULL, "apellidos" character varying(60) NOT NULL, "usuario" character varying(60) NOT NULL, "contrasenia" character varying(60) NOT NULL, "estado" character varying(50) NOT NULL, "rol" character varying(60) NOT NULL, CONSTRAINT "PK_a56c58e5cabaa04fb2c98d2d7e2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "proyecto"."parametros" ("id" BIGSERIAL NOT NULL, "estado" character varying(20) NOT NULL, "nombre" character varying(50) NOT NULL, "sonido" boolean NOT NULL DEFAULT false, "notificacion" boolean NOT NULL DEFAULT false, "envio_noti" character varying(50) NOT NULL, "seguridad_personas" boolean NOT NULL DEFAULT false, "seguridad_bienes" boolean NOT NULL DEFAULT false, "id_simulador" bigint, CONSTRAINT "UQ_18ee965f497758270d758f7f6e0" UNIQUE ("nombre"), CONSTRAINT "PK_c01b42f38ccdc41bdce9cd9fa33" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "proyecto"."ubicacionesAlarmas" ADD CONSTRAINT "FK_4ab2946040a2d31cdf1a6de8db7" FOREIGN KEY ("idAlarma") REFERENCES "proyecto"."parametros"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "proyecto"."historialIncidentes" ADD CONSTRAINT "FK_3e752b22fa4425bbf3311fe09d6" FOREIGN KEY ("idAlarma") REFERENCES "proyecto"."parametros"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "proyecto"."historialActivarDesactivar" ADD CONSTRAINT "FK_f20c61949ef5dd890540c13090a" FOREIGN KEY ("idAlarma") REFERENCES "proyecto"."parametros"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "proyecto"."parametros" ADD CONSTRAINT "FK_65c48c352f15f187d1e1dca146a" FOREIGN KEY ("id_simulador") REFERENCES "proyecto"."simuladores"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "proyecto"."alarmasContactos" ADD CONSTRAINT "FK_3139dc8063176e25215558e688b" FOREIGN KEY ("idAlarma") REFERENCES "proyecto"."parametros"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "proyecto"."parametros" DROP CONSTRAINT "FK_65c48c352f15f187d1e1dca146a"`);
        ...
        await queryRunner.query(`DROP TABLE "proyecto"."parametros"`);
